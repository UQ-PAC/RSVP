...
DROP TABLE secretaries IF EXISTS;
...
CREATE TABLE entity_types (
  ...
  entity_type VARCHAR(20) NOT NULL, -- 'User', 'Administrator', 'Secretary', 'Doctor', 'Adult', 'Patient', 'Visit'.
...
CREATE TABLE secretaries (
  ...
  CONSTRAINT unique_secretary UNIQUE (first_name, last_name, birth_date, gender_id)
);
CREATE INDEX secretaries_last_name ON secretaries (last_name);
...
CREATE TABLE doctors (
  ...
  FOREIGN KEY (entity_id) REFERENCES entities(entity_id) ON DELETE CASCADE,
  FOREIGN KEY (gender_id) REFERENCES genders(id) ON DELETE CASCADE,
  CONSTRAINT unique_doctor UNIQUE (first_name, last_name, birth_date, gender_id)
);
...
CREATE TABLE adults (
  ...
  FOREIGN KEY (entity_id) REFERENCES entities(entity_id) ON DELETE CASCADE,
  FOREIGN KEY (gender_id) REFERENCES genders(id) ON DELETE CASCADE,
  CONSTRAINT unique_adult UNIQUE (first_name, last_name, birth_date, gender_id)
);
CREATE INDEX adults_last_name ON adults (last_name);
...
CREATE TABLE patients (
  ...
  FOREIGN KEY (entity_id) REFERENCES entities(entity_id) ON DELETE CASCADE,
  FOREIGN KEY (gender_id) REFERENCES genders(id) ON DELETE CASCADE,
  CONSTRAINT unique_patient UNIQUE (first_name, last_name, birth_date, gender_id)
);
