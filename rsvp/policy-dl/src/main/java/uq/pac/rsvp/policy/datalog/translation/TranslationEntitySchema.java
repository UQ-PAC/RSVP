 ...
 *
 *  FIXME: This information needs to be collected from the schema, not entittes
 */
public class TranslationEntitySchema extends TranslationComponent {
    ...
    public TranslationEntitySchema(Entity entity, TranslationSchema schema) {
        List<DLStatement> statements = new ArrayList<>();
        TranslationEntity type = schema.getTranslationType(entity.getEUID().getType());
